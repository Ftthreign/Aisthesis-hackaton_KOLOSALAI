      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <ul className="space-y-3">
            {packaging.suggestions.map((suggestion, index) => (
              <li
                key={index}
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {packaging.material_recommendations.map((material, index) => (
              <Badge
                key={index}
                variant="outline"
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-600 dark:text-green-500">
                Consider sustainable packaging options to appeal to environmentally conscious consumers and reduce your carbon footprint.
              </p>
            </div>
          </div>
        </div>
