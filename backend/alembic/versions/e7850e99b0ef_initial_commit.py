...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_analysis_action_plans_id"), "analysis_action_plans", ["id"], unique=False
    )
    op.create_table(
        "analysis_brand_themes",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("analysis_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_analysis_brand_themes_id"), "analysis_brand_themes", ["id"], unique=False
    )
    op.create_table(
        "analysis_marketplaces",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("analysis_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_analysis_marketplaces_id"), "analysis_marketplaces", ["id"], unique=False
    )
    op.create_table(
        "analysis_packagings",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "material_recommendations", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(["analysis_id"], ["analyses.id"], ondelete="CASCADE"),
